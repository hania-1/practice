...
const Fifth: React.FC<Props> = ({ setCurrentPage }) => {
  return (
    <div>
      {/* Header */}
      ...
      {/* Images Section */}
      <div className="flex justify-center gap-8 mt-10 m-10">
        {/* Blog Card 1 */}
        <div className="flex flex-col items-center">
          ...
          <button
            className="text-center mt-2 text-black font-semibold cursor-pointer"
